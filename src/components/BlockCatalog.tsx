...
export default function BlockCatalog() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="px-[1ch] py-3 text-text-muted uppercase border-b border-border-muted">
        Blocks
      </div>
      <div className="px-[1ch] pt-3 pb-6">
        <input
          ...
          className="w-full bg-surface-terminal outline outline-1 outline-border-primary text-text-primary px-[1ch] py-0 font-mono focus:outline-accent"
        />
      </div>
