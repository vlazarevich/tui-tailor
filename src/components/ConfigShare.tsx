      ...
      <div className="px-[1ch] py-0 flex flex-col">
        ...
        <div className="flex gap-[1ch] mb-[1lh]">
          <input
            ...
            className="flex-1 bg-surface-terminal outline-1 outline-border-primary text-text-primary px-[1ch] py-0 font-mono focus:outline-accent"
          />
          <button
            onClick={handleImport}
            disabled={!importValue.trim()}
            className="px-[1ch] py-0 bg-surface-elevated outline-1 outline-border-primary text-text-secondary cursor-pointer hover:text-text-primary disabled:opacity-30 disabled:cursor-default font-mono"
          >
            Load
          </button>
        </div>
