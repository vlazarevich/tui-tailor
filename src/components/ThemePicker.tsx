...
export default function ThemePicker() {
  ...
  return (
    <select
      ...
      className="px-[1ch] py-0 h-6 outline outline-1 outline-border-primary bg-surface-secondary text-text-secondary font-mono cursor-pointer focus:outline-accent hover:text-text-primary"
    >
      {THEMES.map(t => (
